((p, x) => {
    ...
    (p.StickyNav = function () {
                ...
                c.on("mouseup", function (e) {
                    ...
                    o &&
                        ((t = x(o)),
                            ...
                            0 !==
                            x(e.target).closest(".select2-container")
                                .length ||
                            a.is(e.target) ||
                    ...
                    a.steps({
                        ...
                        onStepChanging: function (e, t, n) {
                            return (
                                ...
                                (t < n &&
                                    (a
                                        .find(".body:eq(" + n + ") label.error")
                                        .remove(),
                                        a
                                            .find(".body:eq(" + n + ") .error")
                                            .removeClass("error")),
                                    (a.validate().settings.ignore =
                                        ":disabled,:hidden"),
                                    a.valid())
                            );
                        },
                        onFinishing: function (e, t) {
                            return (
                                (a.validate().settings.ignore = ":disabled"),
                                a.valid()
                            );
                        },
        ...
        (p.DataTable = function (e, s) {
            x(e).exists() &&
                x(e).each(function () {
                    var e = x(this).data("auto-responsive"),
                        t = !(void 0 === s.buttons || !s.buttons),
                        n = e ? "" : "table-responsive",
                        a = x(this).data("export-title")
                        ...
                        o =
                            ...
                            'l>>>><"datatable-wrap ' +
                            n +
                            ' my-3"t><"row align-items-center"<"col-7 col-sm-12 col-md-9"p><"col-5 col-sm-12 col-md-3 text-start text-md-end"i>>',
                        t =
                            '<"row justify-between g-2' +
                            t +
                            '"<"col-7 col-sm-4 text-start"f><"col-5 col-sm-8 text-end"<"datatable-filter"<"d-flex justify-content-end g-2"' +
                        ...
                        n =
                            !1 === e
                                ? u(n, { responsive: !1, autoWidth: !1 })
                                : n;
                    x(this).DataTable(n), x(".dt-export-title").text(a);
                });
        }),
        ...
        (p.Custom.Stepper = function (n, e) {
            var t =
                ...
                o =
                    (n.querySelector(".".concat(t.selectors.progress)),
                        n.querySelector(
                            ".".concat(t.selectors.progress, "-count")
                        )),
                ...
                b =
                    0 <
                    n.querySelectorAll(".".concat(t.selectors.progress)).length;
            function y(e) {
                var t = e - 1,
                    t =
            ...
            r.querySelector("button").addEventListener("click", function (e) {
                ...
                e
                    ? h !== g &&
                    (v && a[t].classList.add(p), i[t].classList.add(f))
        ...
        (p.Preloader = function () {
            ...
            e.exists() &&
                (a.addClass("page-loaded"), e.delay(600).fadeOut(300));
        }),
