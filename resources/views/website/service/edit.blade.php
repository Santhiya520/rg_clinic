    ...
    <div class="nk-block nk-block-lg">
        <div class="card card-preview">
            <div class="card-inner">
                <div class="nk-block-head">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h5 class="title">Edit Service #{{ $service->id }}</h5>
                ...
                <form action="{{ route('website.service.update', $service) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-8">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mt-2">
                                            <small class="text-muted">
                                                ...
                                                Current image: {{ basename($service->image) }}
                                            </small>
                                        </div>
                                    </div>
                                @else
                            ...
                            <div class="form-group">
                                ...
                                <div class="upload-image-box">
                                    ...
                                    <small class="text-muted">
                                        <em class="icon ni ni-info"></em>
                                        Leave empty to keep current image. Max: 5MB (JPEG, PNG, JPG, GIF, WEBP, SVG)
                                    </small>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mt-4" style="background: #f8f9fa;">
                                <div class="card-body">
                                    ...
                                    <dl class="row mb-0">
                                        ...
                                        <dd class="col-sm-7">{{ $service->created_at->format('M d, Y') }}</dd>

                                        <dt class="col-sm-5">Last Updated:</dt>
                                        <dd class="col-sm-7">{{ $service->updated_at->format('M d, Y') }}</dd>
                        ...
                        <div class="col-12">
                            <div class="form-group mt-4">
                                <button type="submit" class="btn btn-primary" style="border-radius: 5px">
                                    <em class="icon ni ni-save"></em> &nbsp; Update Service
                                </button>
                                <a href="{{ route('website.service.index') }}" class="btn btn-outline-light" style="border-radius: 5px">
                                    Cancel
                                </a>
...
// Optional: Confirm before leaving with unsaved changes
...
window.addEventListener('beforeunload', function(e) {
    if (!formSubmitted) {
        // You can add logic here to check if form has changes
