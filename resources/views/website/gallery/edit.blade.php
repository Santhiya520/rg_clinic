    ...
    <div class="nk-block nk-block-lg">
        <div class="card card-preview">
            <div class="card-inner">
                <div class="nk-block-head">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h5 class="title">Edit Gallery Image #{{ $gallery->id }}</h5>
                            <p>Update the gallery image and order.</p>
                        </div>
                        <div class="nk-block-head-content">
                ...
                <form action="{{ route('website.gallery.update', $gallery) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="order" id="order"
                                       ...
                                       value="{{ old('order', $gallery->order) }}" min="0">
                                @error('order')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-12">
                            <div class="form-group mt-4">
                                <button type="submit" class="btn btn-primary" style="border-radius: 5px">
                                    <em class="icon ni ni-save"></em> &nbsp; Update Image
                                </button>
                                <a href="{{ route('website.gallery.index') }}" class="btn btn-outline-light" style="border-radius: 5px">
                                    Cancel
                                </a>
