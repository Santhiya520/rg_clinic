    ...
    <div class="nk-block nk-block-lg">
        <div class="card card-preview">
            <div class="card-inner">
                <div class="nk-block-head">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h5 class="nk-block-title">Add New Operation</h5>
                        </div>
                        <div class="nk-block-head-content">
                ...
                <form action="{{ route('operation-registers.store') }}" method="POST" id="operationForm">
                    @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="patient_id" id="patientSelect" class="form-control js-select2" required
                                    ...
                                    @foreach ($patients as $patient)
                                        <option value="{{ $patient->id }}" data-mobile="{{ $patient->mobile }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="operation_theatre_type" id="theatreTypeSelect" class="form-control js-select2"
                                    ...
                                    <option value=""></option>
                                    <option value="Diabetes and Physician"
                                        {{ old('operation_theatre_type') == 'Diabetes and Physician' ? 'selected' : '' }}>Diabetes and Physician
                                    </option>
                                    <option value="Consultant Paediatrics"
                                        {{ old('operation_theatre_type') == 'Consultant Paediatrics' ? 'selected' : '' }}>Consultant Paediatrics
                                    </option>
                                    <option value="Nephrology"
                                        {{ old('operation_theatre_type') == 'Nephrology' ? 'selected' : '' }}>Nephrology
                                    </option>
                                    <option value="Oncologist"
                                        {{ old('operation_theatre_type') == 'Oncologist' ? 'selected' : '' }}>Oncologist
                                    </option>
                                    <option value="Gastroenterology"
                                        {{ old('operation_theatre_type') == 'Gastroenterology' ? 'selected' : '' }}>Gastroenterology
                                    </option>
                                    <option value="Maternity"
                                        {{ old('operation_theatre_type') == 'Maternity' ? 'selected' : '' }}>Maternity
                                    </option>
                                    <option value="General"
                                        {{ old('operation_theatre_type') == 'General' ? 'selected' : '' }}>General</option>
                                    <option value="Ortho"
                                        {{ old('operation_theatre_type') == 'Ortho' ? 'selected' : '' }}>Ortho</option>
                                    <option value="Cardiac"
                                        {{ old('operation_theatre_type') == 'Cardiac' ? 'selected' : '' }}>Cardiac</option>
                                    <option value="Neuro"
                                        {{ old('operation_theatre_type') == 'Neuro' ? 'selected' : '' }}>Neuro</option>
                                    <option value="ENT" {{ old('operation_theatre_type') == 'ENT' ? 'selected' : '' }}>
                                        ENT</option>
                                    <option value="Eye" {{ old('operation_theatre_type') == 'Eye' ? 'selected' : '' }}>
                                        Eye</option>
                                    <option value="Dental"
                                        {{ old('operation_theatre_type') == 'Dental' ? 'selected' : '' }}>Dental</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="transferred_to_ward" class="form-control"
                                    value="{{ old('transferred_to_ward') }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="provisional_diagnosis" class="form-control" rows="2">{{ old('provisional_diagnosis') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="investigations" class="form-control" rows="2">{{ old('investigations') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="operation_performed" class="form-control" rows="2" required>{{ old('operation_performed') }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="operating_surgeon_id" id="operatingSurgeonSelect"
                                    class="form-control js-select2" required data-placeholder="Select Operating Surgeon">
                                    <option value=""></option>
                                    @foreach ($medicalOfficers as $doctor)
                                        <option value="{{ $doctor->id }}"
                                            {{ old('operating_surgeon_id') == $doctor->id ? 'selected' : '' }}>
                                            {{ $doctor->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="assistant_surgeon_id" id="assistantSurgeonSelect"
                                    class="form-control js-select2" data-placeholder="Select Assistant Surgeon">
                                    <option value=""></option>
                                    @foreach ($medicalOfficers as $doctor)
                                        <option value="{{ $doctor->id }}"
                                            {{ old('assistant_surgeon_id') == $doctor->id ? 'selected' : '' }}>
                                            {{ $doctor->name }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="anaesthetist_id" id="anaesthetistSelect" class="form-control js-select2"
                                    ...
                                    @foreach ($medicalOfficers as $doctor)
                                        <option value="{{ $doctor->id }}"
                                            {{ old('anaesthetist_id') == $doctor->id ? 'selected' : '' }}>
                                            {{ $doctor->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="staff_reception_id" id="staffreceptionSelect"
                                    class="form-control js-select2" data-placeholder="Select Staff reception">
                                    <option value=""></option>
                                    @foreach ($receptions as $reception)
                                        <option value="{{ $reception->id }}"
                                            {{ old('staff_reception_id') == $reception->id ? 'selected' : '' }}>
                                            {{ $reception->name }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="time" name="operation_start_time" class="form-control"
                                    value="{{ old('operation_start_time') }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="time" name="operation_end_time" class="form-control"
                                    value="{{ old('operation_end_time') }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="medical_officer_id" id="medicalOfficerSelect"
                                    class="form-control js-select2" required data-placeholder="Select Medical Officer">
                                    <option value=""></option>
                                    @foreach ($medicalOfficers as $doctor)
                                        <option value="{{ $doctor->id }}"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="operation_notes" class="form-control" rows="3">{{ old('operation_notes') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="additional_information" class="form-control" rows="2">{{ old('additional_information') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mt-4">
                        <button type="submit" class="btn btn-primary" style="border-radius: 6px 0 0 6px">
                            <em class="icon ni ni-save"></em> &nbsp; Create Operation Register
                        </button>
                        <a href="{{ route('operation-registers.index') }}" class="btn btn-secondary">
                            Cancel
                        </a>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            console.log('Initializing Select2 for Operation Register...');
            ...
            // Show patient info when patient is selected
            $('#patientSelect').on('change', function() {
                var selectedOption = $(this).find('option:selected');
                if (selectedOption.val()) {
                    $('#patient-phone').text(selectedOption.data('mobile') || 'N/A');
                    $('#patient-age').text((selectedOption.data('age') || 'N/A') + ' years');
                    $('#patient-gender').text(selectedOption.data('sex') || 'N/A');
            ...
            $('input[name="date_of_admission"]').val(today);

            // Form submission handling
            $('#operationForm').on('submit', function() {
                $(this).find('button[type="submit"]').prop('disabled', true).html(
                    '<em class="icon ni ni-loader"></em> Creating...');
            });
        });
    </script>
@endpush
