            ...
            <div class="text-center py-5">
                <div class="nk-block-content">
                    <div class="nk-block-content-head text-center">
                        ...
                        <p class="text-soft">The patient operation was completed successfully.</p>
                    </div>
                    <div class="nk-block-content-group">
                        <div class="d-flex justify-content-center gap-2 mt-4">
                            <a href="{{ route('patients.index') }}" class="btn btn-primary p-3">
                                <em class="icon ni ni-users"></em> View All Patients
                            </a>
                            <a href="{{ route('op-registers.create') }}" class="btn btn-success p-3">
                                <em class="icon ni ni-plus"></em> Register New OP
                            </a>
