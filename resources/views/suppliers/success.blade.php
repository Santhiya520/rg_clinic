            ...
            <div class="text-center py-5">
                <div class="nk-block-content">
                    <div class="nk-block-content-head text-center">
                        ...
                        <p class="text-soft">The supplier operation was completed successfully.</p>
                    </div>
                    <div class="nk-block-content-group">
                        <div class="d-flex justify-content-center gap-2 mt-4">
                            <a href="{{ route('suppliers.index') }}" class="btn btn-primary p-3">
                                <em class="icon ni ni-users"></em> View All Suppliers
                            </a>
