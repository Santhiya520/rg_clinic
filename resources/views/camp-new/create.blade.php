...
@section('title', 'Create Camp New Record')
@section('page-title', 'Create New Camp New Record')

@section('content')
<div class="nk-block nk-block-lg">
    <div class="card card-preview">
        <div class="card-inner">
            <form action="{{ route('camp-new.store') }}" method="POST" id="campNewForm">
                @csrf
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="token_number" name="token_number"
                                   value="{{ old('token_number') }}" required>
                            @error('token_number')
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="mobile_number" name="mobile_number"
                                   value="{{ old('mobile_number') }}" placeholder="Enter 10-digit mobile number">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="payment_status" name="payment_status">
                                ...
                                <option selected value="paid" {{ old('payment_status') == 'paid' ? 'selected' : '' }}>Paid</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="balance_amount" readonly
                                   value="{{ old('balance_amount', 0) }}" style="background-color: #f8f9fa;">
                        </div>
                    </div>
                ...
                <div class="form-group mt-4">
                    ...
                    <a href="{{ route('camp-new.index') }}" class="btn btn-lg btn-outline-light ml-2">
