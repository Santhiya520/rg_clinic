...
@section('title', 'Create Manual Radiology Test')
@section('page-title', 'Create Manual Radiology Test')

@section('content')
    <div class="nk-block nk-block-lg">
        <form action="{{ route('manual-radiology-tests.store') }}" method="POST">
            @csrf

            <div class="card card-preview">
                <div class="card-inner">
                    <div class="nk-block-head">
                        <h6 class="title">Create New Radiology Test</h6>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div id="items-container">
                                <div class="item-row row mb-3">
                                    <div class="col-md-6">
                                        <select name="items[0][radiology_test_id]"
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary">
                            <em class="icon ni ni-save"></em> Create Test
                        </button>
