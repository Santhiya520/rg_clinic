...
@section('title', 'Create Camp Pharmacy Record')
@section('page-title', 'Create New Camp Pharmacy Record')

@section('content')
<div class="nk-block nk-block-lg">
    <div class="card card-preview">
        <div class="card-inner">
            <form action="{{ route('camp-pharmacy.store') }}" method="POST" id="campPharmacyForm">
                @csrf
