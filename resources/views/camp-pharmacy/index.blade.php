...
@section('title', 'Camp Pharmacy')
@section('page-title', 'Camp Pharmacy Management')
    ...
    <div class="card card-preview">
        <div class="card-inner">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="card-title mb-0">Camp Pharmacy Records</h5>
                <a href="{{ route('camp-pharmacy.create') }}" class="btn btn-primary">
                    <em class="icon ni ni-plus"></em> Add New Record
                </a>
            </div>

            <div class="table-responsive">
                <table id="campPharmacyTable" class="table table-hover">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach($campPharmacies as $record)
                        <tr>
                            <td>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('camp-pharmacy.show', $record->id) }}"
                                       class="btn btn-outline-primary" title="View">
                                        <em class="icon ni ni-eye"></em>
                                    </a>
                                    <a href="{{ route('camp-pharmacy.edit', $record->id) }}"
                                       class="btn btn-outline-info" title="Edit">
                                        <em class="icon ni ni-edit"></em>
                                    </a>
                                    @if($record->total_amount > 0)
                                    <a href="{{ route('camp-pharmacy.print-thermal', $record->id) }}"
                                       target="_blank" class="btn btn-outline-success" title="Print Bill">
                                        <em class="icon ni ni-printer"></em>
                                    </a>
                                    @endif
                                    <form action="{{ route('camp-pharmacy.destroy', $record->id) }}"
                        ...
                        <tr>
                            <td colspan="9" class="text-center py-4">
                                <div class="text-muted">
                                    ...
                                    <p class="mt-2">No camp pharmacy records found</p>
                                    <a href="{{ route('camp-pharmacy.create') }}" class="btn btn-sm btn-primary mt-2">
