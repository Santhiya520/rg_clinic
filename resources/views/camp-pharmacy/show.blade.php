...
@section('title', 'View Camp Pharmacy Record')
@section('page-title', 'Camp Pharmacy Record Details')
        ...
        <div class="card-inner">
            <div class="row mb-4">
                ...
                <div class="col-md-6 text-right">
                    <div class="btn-group">
                        <a href="{{ route('camp-pharmacy.edit', $record->id) }}" class="btn btn-outline-primary">
                            <em class="icon ni ni-edit"></em> Edit
                        </a>
                        <a href="{{ route('camp-pharmacy.print-thermal', $record->id) }}" target="_blank" class="btn btn-outline-success">
                            <em class="icon ni ni-printer"></em> Print Bill
                        </a>
                        <a href="{{ route('camp-pharmacy.index') }}" class="btn btn-outline-light">
