...
@section('title', 'Radiology Reports - ' . $patient->name)
        ...
        <div class="card-inner">
            ...
            <div class="nk-block-head">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">My Radiology Reports</h3>
                        <div class="nk-block-des text-soft">
                            <p>View all your radiology test reports</p>
            ...
            <div class="card card-bordered mb-4">
                <div class="card-inner">
                    ...
                    <form method="GET" action="{{ route('online.radiology.reports') }}" class="row g-3" id="dateFilterForm">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            <div class="btn-group w-100">
                                ...
                                <a href="{{ route('online.radiology.reports') }}" class="btn btn-secondary">
            ...
            @if(!$hasFilter)
                <div class="text-center p-5 border rounded bg-light">
                    ...
                    <p class="text-muted mb-4">Please select a date range using the filter above to view your radiology reports.</p>
                    ...
                    <div class="alert alert-info text-left">
                        ...
                        <ul class="mt-2 mb-0 pl-3">
                            ...
                            <li>Only completed reports with uploaded documents will be shown</li>
                        </ul>
                    </div>
                </div>
            @else
                ...
                @if($totalTests == 0)
                    <div class="alert alert-warning alert-icon">
                        <em class="icon ni ni-info"></em>
                        <strong>No radiology tests found for the selected date range ({{ $dateRange }}).</strong>
                ...
                @else
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @forelse ($allRadiologyTests as $index => $test)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>
                                            <strong>{{ $test->radiologyTest->name ?? 'N/A' }}</strong>
                                            @if($test->notes)
                                                <br><small class="text-muted">{{ Str::limit($test->notes, 50) }}</small>
                                            @endif
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center py-4">
                                            ...
                                            <p class="mt-2">No radiology tests found for the selected date range.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                    ...
                    <div class="alert alert-info alert-icon mt-4">
                        ...
                        <strong>Note:</strong>
                        <ul class="mt-2 mb-0 pl-3">
                            <li>Click "View" to open the radiology report document</li>
                            <li>Completed tests show green status with available reports</li>
                            <li>Pending tests are still being processed</li>
                            <li>Reports are available only for completed tests</li>
